...
class EmployeePartialSolutionPrinter(cp_model.CpSolverSolutionCallback):
    ...
    def __init__(self, shifts, num_emp, num_days, num_shifts, sols):
        cp_model.CpSolverSolutionCallback.__init__(self)
        self._shifts = shifts
        self._num_emp = num_emp
...
def main():
    ...
    min_shifts_per_nurse = (num_shifts * num_days) // num_emp
    ...
    solution_printer = EmployeePartialSolutionPrinter(
        shifts, num_emp, num_days, num_shifts, a_few_solutions)
